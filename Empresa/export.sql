...
-- Copiando dados para a tabela empresa.pessoa: ~10 rows (aproximadamente)
DELETE FROM `pessoa`;
...
INSERT INTO `projeto` (`id`, `nome`, `descricao`, `id_funcionario`) VALUES
	...
	(2, 'Treinamento Interno', 'Capacitação dos novos funcionários.', 2),
	...
	(10, 'Monitoramento TI', 'Sistema de monitoramento proativo da infraestrutura.', 10);
